...
save_all_figures <- function(model_names, models_list, metrics_list, train_df_l, val_df_l, width, height, dpi, main_path, filename_addon="") {
  ...
  auc_summary <- read_parquet(paste0(main_path, "auc_summary", filename_addon, ".parquet"))
  ...
  ggsave(
    paste0(main_path, "specificity_plot", filename_addon, ".pdf"),
  ...
  ggsave(
    paste0(main_path, "ppv_plot", filename_addon, ".pdf"),
    plot = ppv_plot,
    width = width * 1.2,
    height = 6,
    dpi = dpi
  ...
  ggsave(
    paste0(main_path, "npv_plot", filename_addon, ".pdf"),
    plot = npv_plot,
    width = width * 1.2,
    height = 6,
    dpi = dpi
