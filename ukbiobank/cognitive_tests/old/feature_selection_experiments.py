...
def main():
    ...
    if experiment == 'modality_only':
        ...
        X = X.loc[:, df_utils.pull_columns_by_prefix(X, [f'21003-{data_instance}.0', '31-0.0', 'apoe', 'max_educ_complete', '845-0.0', '21000-0.0']).columns.tolist() + cog_vars]
        time_budget = 400
    ...
    test_df.to_csv(f'{directory_path}/test_results_region_{i}.csv')
        ...
        # plot_title = {'cognitive_tests_only': 'All Cognitive Tests', 'demographics_and_cognitive_tests': 'All Demographics + Cognitive Tests'}
