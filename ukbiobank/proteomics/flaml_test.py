...
def main():
    ...
    experiment = 'age_only' #args.experiment
    time_budget = '3600' #args.time_budget
    metric = 'log_loss' #args.metric
    age_cutoff = 0 # args.age_cutoff
    if age_cutoff == 0:
        age_cutoff = None
    # file_suffix = args.file_suffix
    region_index = 1 #args.region_index
    ...
    file_path = f'{directory_path}/testtest_training_results_region_.csv'
    ...
    # train_df.to_csv(f'{directory_path}/testtest_training_results_region_{i}.csv')

    # test_df = pd.concat(test_res_l, axis=1).T
    # test_df.to_csv(f'{directory_path}/testtest_test_results_region_{i}.csv')
